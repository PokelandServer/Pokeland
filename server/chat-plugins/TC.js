...
exports.commands = {
    ...
    trainercard: function (target, room, user) {
        ...
        case 'help':
            ...
            this.sendReplyBox(
                "EZ-TC Commands:<br />" +
                "/trainercard add, [command name], [html] - Ajoute une cartes dresseurs.<br />" +
                "/trainercard remove, [command name] - Supprime une trainer card.<br />" +
                "/trainercard list - Affiche une liste de toutes cartes dresseurs ajoutées avec cette commande.<br />" +
                "/trainercard off - Désactive les trainer cards en broadcast dans la room actuelle.<br />" +
                "/trainercard on - Active les cartes dresseurs en broadcast dans la room actuelle.<br />" +
                "/trainercard help - Montre cette commande d'aide.<br />" 
            );
        }
    },
};