...
exports.commands = {
	...
	shoot: commands.fire,
	ambushhelp: [
		`/ambush start [seconds] - Starts a a game of Ambush in the room. The first round will begin after the mentioned number of seconds (1 minute by default). Requires + or higher to use.
